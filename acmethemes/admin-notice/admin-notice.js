...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.at-gsm-btn' ).click( function ( e ) {
		...
		$( this ).text( prolific_adi_install.btn_text );
		...
		$.ajax({
			...
			data: {
				...
				security : prolific_adi_install.nonce,
				...
				setTimeout(function(){
					$.ajax({
						...
						success:function( response ) {
							...
							redirect_uri         = prolific_adi_install.adminurl+'/themes.php?page=advanced-import&browse=all&at-gsm-hide-notice=welcome';
